...
\begin{document}
  ...
  the duration of their terms unless removed by the team.

  \subsection{Voting}
  All issues that are disputed by the team will be decided by a vote.
  All issues must have a majority to pass and therefore, issues that
  result in a split vote do not pass.
  ...
  members of the executive board that have not previously been removed are
  ...
  board until the end of the original officeri's term.
  ...
  to violate the previous clause then all removals are blocked until a position
